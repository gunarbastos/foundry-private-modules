 ...
 * @param {object} data - { segments, filled, filledColor, emptyColor, style }
...
/**
 * Reposition all clock HUDs in a vertical stack from bottom-left.
 */
function _repositionClockHuds() {
  let offset = 16;
  for (const el of _activeClockHuds.values()) {
